...
public:
  ...
  */
  ...
  su2double GetTopOptMinElasticity(void);
  su2double GetTopOptPenalty(void);
  su2double GetTopOptVolumeFraction(void);
  ...
  unsigned short GetEqualConstraint(unsigned short valu);
  su2double GetConstraintFactor(unsigned short valu);
  su2double GetConstraintStart(void);
  unsigned long GetConstraintNum(void);
