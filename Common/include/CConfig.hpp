...
private:
  ...
  *Wall_Catalytic;                          /*!< \brief Pointer to catalytic walls. */
  ...
  su2double* MultiplierScale;   /*! \brief Scaling value for constraint multiplier. */
...
public:
  ...
  */
   ...
   */
  su2double GetOneShotAlpha(void) const { return One_Shot_Alpha; }
   ...
   */
  su2double GetOneShotBeta(void) const { return One_Shot_Beta; }

  /*!
   * \brief Set the multiplier for the "alpha"-term in the doubly augmented Lagrangian.
   * \return Value for alpha multiplier in one-shot method
   */
  void SetOneShotAlpha(su2double input) { One_Shot_Alpha = input; }

  /*!
   * \brief Set the multiplier for the "beta"-term in the doubly augmented Lagrangian.
   * \return Value for beta multiplier in one-shot method
   */
  void SetOneShotBeta(su2double input) { One_Shot_Beta = input; }
   ...
   */
  bool GetCheckDescent(void) const { return OS_Check_Descent; }
   ...
   */
  bool GetOneShotLagrange(void) const { return OS_Lagrange; }
   ...
   */
  bool GetOneShotPartStep(void) const { return OS_LS_PrimalDual; }

  /*!
   * \brief Maximum line search counter for one-shot.
   * \return Value for the maximum number of line searches.
   */
  unsigned short GetOneShotMaxCounter(void) const { return OS_LS_MaxCounter; }
   ...
   */
  bool GetZeroStep(void) const { return Zero_Step; }

  /*!
   * \brief Get the initial value of the stepsize for line search
   * \return Value of initial stepsize.
   */
  su2double GetStepSize(void) const {return Step_Size; }

  /*!
   * \brief Get the initial scaling of the BFGS inverse
   * \return Value of initial scaling.
   */
  su2double GetBFGSInitValue(void) const {return BFGS_Init_Value; }

  /*!
   * \brief Get the epsilon value for the constraint preconditioner
   * \return Value of epsilon.
   */
  su2double GetBCheckEpsilon(void) const {return BCheck_Epsilon; }

  /*!
   * \brief Get the value for the multiplier scaling
   * \return Value of multiplier scaling.
   */
  su2double GetMultiplierScale(unsigned short val_cons) const { return MultiplierScale[val_cons]; }

  /*!
   * \brief Check if constant preconditioner is used
   * \return YES if constant preconditioner is used
   */
  bool GetConstPrecond(void) const { return Constant_Preconditioner; }

  /*!
   * \brief Check if AD is used for projecting derivatives
   * \return YES if AD is used for projecting derivatives
   */
  bool GetProjectionAD(void) const { return Projection_AD; }
