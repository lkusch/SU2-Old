...
namespace SU2_TYPE{
  inline void SetPrimary(su2double& data, const double &val){data.value()=val;}

  inline double GetPrimary(const su2double& data){return data.getValue();}

  inline void SetSecondary(su2double& data, const double &val){data.gradient() = val;}
  ...
  inline void SetDerivative(su2double& data, const double &val){data.gradient() = val;}
}
namespace AD{
