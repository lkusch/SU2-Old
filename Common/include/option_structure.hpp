...
enum ENUM_MAIN_SOLVER {
  ...
  ONE_SHOT_EULER = 43,              /*!< \brief Definition of the one-shot Euler's optimization. */
  ONE_SHOT_RANS = 44,               /*!< \brief Definition of the RANS' optimization. */
  ONE_SHOT_NAVIER_STOKES = 45       /*!< \brief Definition of the Navier-Stokes' optimization. */
};
static const MapType<string, ENUM_MAIN_SOLVER> Solver_Map = {
  ...
  MakePair("ONE_SHOT_EULER", ONE_SHOT_EULER)
  MakePair("ONE_SHOT_RANS", ONE_SHOT_RANS)
  MakePair("ONE_SHOT_NAVIER_STOKES", ONE_SHOT_NAVIER_STOKES)
};
...
static const MapType<string, ENUM_MATH_PROBLEM> Math_Problem_Map = {
  ...
  MakePair("DISCRETE_ADJOINT_ONE_SHOT", DISCRETE_ADJOINT_ONE_SHOT)
};
...
static const MapType<string, ENUM_OBJECTIVE> Objective_Map = {
  ...
  MakePair("AIRFOIL_AREA", AIRFOIL_AREA)
  MakePair("MAX_THICKNESS", MAX_THICKNESS)
};
