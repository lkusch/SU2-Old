...
inline su2double CConfig::GetTopOptMinElasticity(void) {return TopOptMinElasticity;}

inline su2double CConfig::GetTopOptPenalty(void){return TopOptPenalty;}

inline su2double CConfig::GetTopOptVolumeFraction(void) {return TopOptVolumeFraction;}
...
inline unsigned short CConfig::GetEqualConstraint(unsigned short valu){ return EqualConstraint[valu];}
inline su2double CConfig::GetConstraintFactor(unsigned short valu){ return ConstraintFactor[valu];}
inline su2double CConfig::GetConstraintStart(void){ return ConstraintStart;}
inline unsigned long CConfig::GetConstraintNum(void){return ConstraintNum;}
