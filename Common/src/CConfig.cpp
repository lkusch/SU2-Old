...
void CConfig::SetPointersNull(void) {
  ...
  Weight_ObjFunc = nullptr;
  Multiplier_Start = nullptr;
  Multiplier_Factor = nullptr;
  ConstraintTarget = nullptr;
  ConstraintScale = nullptr;
  MultiplierScale = nullptr;
 ...
 delete [] LocationStations;
  ...
  if (DoubleInfo_WallFunctions != nullptr) {
    ...
    delete[] DoubleInfo_WallFunctions;
       ...
       delete[] Kind_ObjFunc;
       delete[] Weight_ObjFunc;
  if (Kind_ConstrFunc != nullptr)  	delete[] Kind_ConstrFunc;
  if (Multiplier_Start != nullptr)      delete[] Multiplier_Start;
  if (Multiplier_Factor != nullptr)     delete[] Multiplier_Factor;
  if (ConstraintTarget != nullptr)      delete[] ConstraintTarget;
  if (ConstraintScale != nullptr)      	delete[] ConstraintScale;
  if (MultiplierScale != nullptr)      	delete[] MultiplierScale;
