...
def main():
    ...
    sys.stdout.write('|   |___/\\___//___|   Aerodynamic Shape Optimization Script (IPOPT)      |\n')
    sys.stdout.write('|                                                                       |\n')
    sys.stdout.write('-------------------------------------------------------------------------\n')
...
def shape_optimization( filename                , 
    ...
    #SU2.opt.APOSTERIORI(project,config,state,x0,xb_low,xb_up,its,accu,0.6922)
    #SU2.opt.EXPVAR(project,config,state,x0,xb_low,xb_up,its,accu,0.0173862767)
