/*!
 * \file COneShotMultizoneDriver.hpp
 * \brief Class for driving one-shot multi-zone problems (only placeholder, not tested)
 * \author L. Kusch
...
#pragma once
#include "CDiscAdjMultizoneDriver.hpp"

/*!
 * \class COneShotMultizoneDriver
 * \brief Class for driving single-zone adjoint solvers.
 * \author L. Kusch
 * \version 7.1.1 "Blackbird"
 */
class COneShotMultizoneDriver : public CDiscAdjMultizoneDriver {
protected:
...
public:
   ...
   */
  COneShotMultizoneDriver(char* confFile,
   ...
   */
  ~COneShotMultizoneDriver(void) override;
