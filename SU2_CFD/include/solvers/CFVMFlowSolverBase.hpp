...
class CFVMFlowSolverBase : public CSolver {
 ...
 protected:
  ...
  vector<su2double> ConstraintFunction;  /*!< \brief Vector of constraint values */
 ...
 public:
   ...
   */
  inline void SetConstraintFunction(su2double Constraint, unsigned short iConstr) final { ConstraintFunction[iConstr]= Constraint; }
   ...
   */
  inline su2double GetConstraintFunction(unsigned short iConstr) const final { return ConstraintFunction[iConstr]; }
