...
public:
   ...
   * \param[in] config - Definition of the particular problem.
   * \param[in] iConstr - Number of constraint function.
   * \return Value of the constraint function. 
   */
  inline virtual su2double Evaluate_ConstrFunc(const CConfig *config, unsigned short iConstr) { return 0.0; }
 ...
 /*!
  ...
  /*!
   * \brief A virtual member.
   * \param[in] Constraint - Value of the constraint function.
   * \param[in] iConstr - Number of the constraint function. 
   */
  inline virtual void SetConstraintFunction(su2double Constraint, unsigned short iConstr) {}

  /*!
   * \brief Provide the constraint function.
   * \param[in] iConstr - Number of the constraint function. 
   * \return Value of the constraint function.
   */
  inline virtual su2double GetConstraintFunction(unsigned short iConstr) const { return 0;}
  ...
  */
   ...
   * \brief A virtual member.
   */
  inline virtual void StoreSolution() {}
   ...
   * \brief A virtual member.
   */
  inline virtual void LoadSolutionStep(su2double stepsize) {}

  /*!
   * \brief A virtual member.
   */
  inline virtual void StoreSaveSolution() {}
   ...
   * \brief A virtual member.
   */
  inline virtual void StoreFormerSolution() {}

  /*!
   * \brief A virtual member.
   */
  inline virtual void ShiftFormerSolution() {}

  /*!
   * \brief A virtual member.
   */
  inline virtual void ShiftStoreSolution() {}

  /*!
   * \brief A virtual member.
   */
  inline virtual void StoreSolutionDelta() {}
   ...
   */
  inline virtual void StoreMeshPoints(CConfig *config, CGeometry *geometry) {}
   ...
   * \param[in] geometry - geometry class object
   */
  inline virtual void LoadMeshPoints(CConfig *config, CGeometry *geometry) {}

  /*!
   * \brief A virtual member.
   * \param[in] geometry - geometry class object
   */
  inline virtual void SaveSensitivity(CGeometry *geometry) {}
   ...
   * \param[in] geometry - geometry class object
   */
  inline virtual void SetGeometrySensitivityLagrangian(CGeometry *geometry) {}
   ...
   */
  inline virtual su2double CalculateLagrangianPart(CConfig *config, bool augmented) { return 0.0; }

  /*!
   * \brief A virtual member.
   */
  inline virtual void CalculateAlphaBeta() {}

  /*!
   * \brief A virtual member.
   * \param[in] config - config class object
   */
  inline virtual void SetAlphaBeta(CConfig *config) {}

  /*!
   * \brief A virtual member.
   * \param[in] geometry - geometry class object
   */
  inline virtual void ResetSensitivityLagrangian(CGeometry *geometry) {}

  /*!
   * \brief A virtual member.
   * \param[in] geometry - geometry class object
   */
  inline virtual void UpdateSensitivityLagrangian(CGeometry *geometry, su2double factor) {}
   ...
   * \brief A virtual member.
   */
  inline virtual su2double MultiplyConstrDerivative(unsigned short iConstr, unsigned short jConstr) { return 0.0; }
