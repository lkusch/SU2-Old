...
public:
   ...
   */
  inline void SetSensitivity_ShiftedLagrangian(unsigned long iPoint, unsigned long iDim, su2double val) override { Sensitivity_ShiftedLagrangian(iPoint,iDim) = val;}
   ...
   */
  inline su2double GetSensitivity_ShiftedLagrangian(unsigned long iPoint, unsigned long iDim) const override { return Sensitivity_ShiftedLagrangian(iPoint,iDim); }
   ...
   * \param[in] val - value of the Sensitivity (Shifted Lagrangian)
   */
  inline void SetSensitivity_AugmentedLagrangian(unsigned long iPoint, unsigned long iDim, su2double val) override { Sensitivity_AugmentedLagrangian(iPoint,iDim) = val;}
