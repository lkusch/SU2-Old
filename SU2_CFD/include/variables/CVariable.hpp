...
public:
   ...
   */
  inline virtual void SetSensitivity_ShiftedLagrangian(unsigned long iPoint, unsigned long iDim, su2double val) { }

  /*!
   * \brief Get the Sensitivity of the shifted Lagrangian at the node
   * \param[in] iDim - spacial component
   * \return value of the Sensitivity (Shifted Lagrangian)
   */
  inline virtual su2double GetSensitivity_ShiftedLagrangian(unsigned long iPoint, unsigned long iDim) const { return 0.0; }

  /*!
   * \brief Set the sensitivity of the augmented Lagrangian at the node
   * \param[in] iDim - spacial component
   * \param[in] val - value of the Sensitivity (Shifted Lagrangian)
   */
  inline virtual void SetSensitivity_AugmentedLagrangian(unsigned long iPoint, unsigned long iDim, su2double val) { }

  /*!
   * \brief Get the Sensitivity of the augmented Lagrangian at the node
   * \param[in] iDim - spacial component
   * \return value of the Sensitivity (Augmented Lagrangian)
   */
  inline virtual su2double GetSensitivity_AugmentedLagrangian(unsigned long iPoint, unsigned long iDim) const { return 0.0; }
   ...
   */
  inline void SetSolution_Store(unsigned long iPoint, const su2double *solution){
    for (unsigned long iVar = 0; iVar < nVar; iVar++) Solution_Store(iPoint,iVar) = solution[iVar];
  }
   ...
   */
  inline su2double GetSolution_Store(unsigned long iPoint, unsigned long iVar) const { return Solution_Store(iPoint,iVar); }
   ...
   */
  inline su2double GetSolution_Save(unsigned long iPoint, unsigned long iVar) const { return Solution_Save(iPoint, iVar); }
   ...
   */
  inline void SetSolution_Former(unsigned long iPoint, const su2double *solution){
    for (unsigned long iVar = 0; iVar < nVar; iVar++) Solution_Former(iPoint,iVar) = solution[iVar];
  }
   ...
   */
  inline su2double GetSolution_Former(unsigned long iPoint, unsigned long iVar) const { return Solution_Former(iPoint,iVar); }
   ...
   */
  inline void SetSolution_Delta(unsigned long iPoint, unsigned long iVar, su2double val_solution_delta) { Solution_Delta(iPoint,iVar) = val_solution_delta; }
   ...
   * \param[in] val_solution_delta - value that is set
   */
  inline void SetSolution_Delta_Store(unsigned long iPoint, unsigned long iVar, su2double val_solution_delta_store) { Solution_Delta_Store(iPoint,iVar) = val_solution_delta_store; }
   ...
   */
  inline su2double GetSolution_Delta(unsigned long iPoint, unsigned long iVar) const { return Solution_Delta(iPoint, iVar); }
   ...
   */
  inline su2double GetSolution_Delta_Store(unsigned long iPoint, unsigned long iVar) const { return Solution_Delta_Store(iPoint, iVar); }
};
