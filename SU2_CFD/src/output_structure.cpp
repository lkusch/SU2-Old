...
void COutput::SetConvHistory_Body(ofstream *ConvHist_file,
  ...
  if (rank == MASTER_NODE) {
    ...
    Total_AoA = 0.0;
    su2double Surface_MassFlow = 0.0, Surface_Mach = 0.0, Surface_Temperature = 0.0, Surface_Pressure = 0.0, Surface_Density = 0.0, Surface_Enthalpy = 0.0, Surface_NormalVelocity = 0.0, Surface_TotalTemperature = 0.0, Surface_TotalPressure = 0.0, Surface_TotalFlowUniformityIndex = 0.0;
      ...
      if (!DualTime_Iteration) {
        ...
        switch (config[val_iZone]->GetKind_Solver()) {
          ...
          case DISC_ADJ_NAVIER_STOKES: case DISC_ADJ_RANS:
            ...
            if (output_surface) {
              SPRINTF( surface_outputs, ", %14.8e, %14.8e, %14.8e, %14.8e, %14.8e, %14.8e, %14.8e, %14.8e, %.10lf", Surface_MassFlow, Surface_Mach, Surface_Temperature, Surface_Pressure, Surface_Density, Surface_Enthalpy, Surface_NormalVelocity, Surface_TotalTemperature, Surface_TotalPressure);
            }
...
<<<<<<< HEAD
  ...
  Velocity[3], Velocity2, MassFlow, Density, Energy, Area, AxiFactor = 1.0, SoundSpeed, Vn, VnDiff, Weight = 1.0;
=======
...
>>>>>>> 7c5196dd4a89db56ee9262f3a4abe4cd948745c1
