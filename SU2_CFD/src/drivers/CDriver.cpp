...
void CDriver::Inlet_Preprocessing(CSolver ***solver, CGeometry **geometry,
  ...
  switch (config->GetKind_Solver()) {
    ...
    case DISC_ADJ_EULER: case DISC_ADJ_INC_EULER: case ONE_SHOT_EULER: euler = true; disc_adj = true; break;
    case DISC_ADJ_NAVIER_STOKES: case DISC_ADJ_INC_NAVIER_STOKES: case ONE_SHOT_NAVIER_STOKES: ns = true; disc_adj = true; break;
    case DISC_ADJ_RANS: case DISC_ADJ_INC_RANS: case ONE_SHOT_RANS: ns = true; turbulent = true; disc_adj = true; disc_adj_turb = (!config->GetFrozen_Visc_Disc()); break;
...
void CDriver::Solver_Restart(CSolver ***solver, CGeometry **geometry,
  ...
  switch (config->GetKind_Solver()) {
    ...
    case ONE_SHOT_EULER: case ONE_SHOT_NAVIER_STOKES: case ONE_SHOT_RANS: restart=false; restart_flow=false; break;
