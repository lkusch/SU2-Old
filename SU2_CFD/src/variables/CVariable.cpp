...
void CVariable::Set_SaveSolution() {
  assert(Solution.size() == Solution_Save.size());
  parallelCopy(Solution.size(), Solution.data(), Solution_Save.data());
}

void CVariable::Set_FormerSolution() {
  assert(Solution.size() == Solution_Former.size());
  parallelCopy(Solution.size(), Solution.data(), Solution_Former.data());
}
